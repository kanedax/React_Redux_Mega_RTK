    ...
    <section className="py-16 xl:pb-56 bg-white overflow-hidden">
      <div className="container px-4 mx-auto">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="mb-6 font-medium text-lg text-gray-600 leading-normal">
          ...
          <form onSubmit={onSubmit}>
            <label className="block mb-5">
              <input
                ...
                onChange={onChange}
                name="name"
                className="px-4 py-3.5 w-full text-gray-700 font-medium placeholder-gray-500 bg-white outline-none border border-gray-300 rounded-lg focus:ring focus:ring-indigo-300"
                id="signUpInput2-1"
                type="text"

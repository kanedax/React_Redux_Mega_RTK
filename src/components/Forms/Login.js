          ...
          <div className="max-w-xl mx-auto py-10 px-8 sm:px-20 bg-white rounded-md">
            <div className="mb-6">
              ...
              {userAuth?.error?.message && (
                <h2 className="text-red-500 mt-4 mb-0">
                  {userAuth?.error?.message}
                </h2>
              )}
            </div>
            <form onSubmit={onSubmitHandler}>
              ...
              <div className="text-right mb-6">
                {loading ? (
                  <button
                    className="block w-full py-4 px-6 text-center font-heading font-medium text-base text-white bg-gray-500  border rounded-sm transition duration-200"
                    type="submit"
                    disabled
                  >
                    loading...
